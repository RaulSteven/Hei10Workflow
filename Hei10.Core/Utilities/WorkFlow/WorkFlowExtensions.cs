...
namespace Hei10.Core.Utilities.WorkFlow
{
    /// <summary>
    ///ExtString 的摘要说明
    /// </summary>
    public static class WorkFlowExtensions
    {
        ...
        {
            return WorkFlowEncryption.Encrypt(str);
        }
        /// <summary>
        /// AES解密字符串
        /// </summary>
        ...
        {
            return WorkFlowEncryption.Decrypt(str);
        }
        ...
        {
            return WorkFlowEncryptionDes.Encrypt(str);
        }
        /// <summary>
        /// DES解密字符串
        /// </summary>
        ...
        {
            return WorkFlowEncryptionDes.Decrypt(str);
        }
